...
for path in web/src/components/message/MessageActions.tsx app/src/components/message/MessageActions.tsx; do
  require_match "messageAuthorMenuAction" "$path"
...
require_match "message author menu offers delete to self and mute to another author" worldlib/test/mute.test.cjs
